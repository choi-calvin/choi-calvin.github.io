...
export class AboutContainer extends Component {
  render() {
    const cognitiveScienceText = "Cognitive Science is the interdisciplinary study of the mind and its processes from the \
    intersection of six major fields: Philosophy, Psychology, Anthropology, Linguistics, Neuroscience, and Artificial \
    Intelligence.";
    const websiteText = "Yup. This website was built and published with React.js, Bootstrap, CSS, and HTML. It took three \
    weeks from self-learning the necessary languages, to designing the UI, to buying the domain.";
