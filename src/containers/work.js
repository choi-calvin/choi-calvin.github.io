...
export class WorkContainer extends Component {
  render() {
    const eyetrackingText = "Eye tracking is a common type of study in the field of psychology and is a growing means of obtaining data. Measurements on the eye's gazes, fixations, and blinks are captured and recorded using an eye tracking device, then outputted into data. This data is often large (over dozens of gigabytes, depending on the study) and difficult to interpret.";

    const teamText = "Although I was on the back-end for the majority of the project, we were required to know of all the functionality in both ends, as well as how they connected. Because of time restraints, I shifted over to help build the UI in the last portion of the project.";
    ...
    return (
      <div>
        ...
        <h3>Duncan Lab</h3>
        <p>I worked at the <a href="http://duncanlab.org/" id="link" target="_blank" without rel="noopener noreferrer">Duncan Lab</a> the summer of 2018.
        ...
        <p>I learned and created an iOS game from scratch. I designed the UI and all the resources with image editing software. I also hooked up
          ...
          enhance the game experience. You can preview and download the app <a href="https://itunes.apple.com/app/id1408051434" target="_blank" id="link" without rel="noopener noreferrer">here</a> to beat my high score <small>(140, by the way)</small>.</p>
        <h3>Image Tagger</h3>
        ...
        <p>My favourite languages and skillset include Python, Java, C, iOS, Object-Oriented-Programming, and general software development. View my resume for more information.</p>
      </div>
    );
  }
}
